...
img.css('background-image', function () {
  ...
  $(function () {
	...
	// Optional plugins: these may be intentionally excluded on some pages for performance.
	...
	if ($.fn && typeof $.fn.lightcase === 'function') {
...
function mainSlider() {
	...
	if (!($.fn && typeof $.fn.slick === 'function') || !BasicSlider.length) {
		return;
	}
