...
<head>
    ...
    @if(!request()->routeIs('plans'))
        @include('partials.preload-style', ['href' => asset($activeTemplateTrue . 'css/lightcase.css')])

        @include('partials.preload-style', ['href' => asset($activeTemplateTrue . 'css/vendor/animate.min.css')])

        @include('partials.preload-style', ['href' => asset($activeTemplateTrue . 'css/vendor/nice-select.css')])

        @include('partials.preload-style', ['href' => asset($activeTemplateTrue . 'css/vendor/slick.css')])
    @endif

    @include('partials.preload-style', ['href' => asset($activeTemplateTrue . 'css/main.css')])

    @include('partials.preload-style', ['href' => asset($activeTemplateTrue . 'css/custom.css')])
    @stack('style-lib')

    @stack('style')

    @include('partials.preload-style', ['href' => asset($activeTemplateTrue . 'css/color.php') . '?color1=' . $general->base_color . '&color2=' . $general->secondary_color])
