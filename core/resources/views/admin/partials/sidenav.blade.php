        ...
        <div class="sidebar__menu-wrapper" id="sidebar__menuWrapper">
            <ul class="sidebar__menu">
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.free-user*',3)}}">
                        <i class="menu-icon las la-user-alt"></i>
                        <span class="menu-title">@lang('Free User System')</span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.free-user*',2)}}">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.free-user.index')}}">
                                <a href="{{route('admin.free-user.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Settings')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.free-user.free-users')}}">
                                <a href="{{route('admin.free-user.free-users')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Free Users')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.free-user.premium-users')}}">
                                <a href="{{route('admin.free-user.premium-users')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Premium Users')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.premium.commission*',3)}}">
                        <i class="menu-icon las la-crown"></i>
                        <span class="menu-title">@lang('Premium Commissions')</span>
                        @php $pendingPremium = \App\Models\PremiumReferralCommission::where('status', 'pending')->count(); @endphp
                        @if($pendingPremium > 0)
                            <span class="menu-badge pill bg--warning ms-auto">{{ $pendingPremium }}</span>
                        @endif
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.premium.commission*',2)}}">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.premium.commission.index')}}">
                                <a href="{{route('admin.premium.commission.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.premium.commission.pending')}}">
                                <a href="{{route('admin.premium.commission.pending')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                            ...
                            <li class="sidebar-menu-item {{menuActive('admin.premium.commission.approved')}}">
                                <a href="{{route('admin.premium.commission.approved')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Approved')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.premium.commission.locked')}}">
                                <a href="{{route('admin.premium.commission.locked')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Locked')</span>
                                </a>
                            </li>
                        </ul>
                    </div>
                ...
                <li class="sidebar-menu-item sidebar-dropdown">
                    <a href="javascript:void(0)" class="{{menuActive('admin.red-bag*',3)}}">
                        <i class="menu-icon las la-gift"></i>
                        <span class="menu-title">@lang('Red Bag')</span>
                    </a>
                    <div class="sidebar-submenu {{menuActive('admin.red-bag*',2)}}">
                        <ul>
                            <li class="sidebar-menu-item {{menuActive('admin.red-bag.index')}}">
                                <a href="{{route('admin.red-bag.index')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('All Red Bags')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.red-bag.create')}}">
                                <a href="{{route('admin.red-bag.create')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Create New')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.red-bag.claims')}}">
                                <a href="{{route('admin.red-bag.claims')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                                    <span class="menu-title">@lang('Claims')</span>
                                </a>
                            </li>
                            <li class="sidebar-menu-item {{menuActive('admin.red-bag.statistics')}}">
                                <a href="{{route('admin.red-bag.statistics')}}" class="nav-link">
                                    <i class="menu-icon las la-dot-circle"></i>
                ...
                <li class="sidebar__menu-header">@lang('App Features')</li>

                <li class="sidebar-menu-item {{menuActive('admin.popup.*')}}">
                    <a href="{{route('admin.popup.index')}}" class="nav-link">
                        <i class="menu-icon las la-window-restore"></i>
                        <span class="menu-title">@lang('Popup Announcements')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.announcement.*')}}">
                ...
                <li class="sidebar-menu-item {{menuActive('admin.tutorial.*')}}">
                    <a href="{{route('admin.tutorial.index')}}" class="nav-link">
                        <i class="menu-icon las la-video"></i>
                        <span class="menu-title">@lang('Video Tutorials')</span>
                    </a>
                </li>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.agco.brand.*')}}">
                    <a href="{{route('admin.agco.brand.index')}}" class="nav-link">
                        ...
                        <span class="menu-title">@lang('AGCO Family Brands')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.whatsapp.contacts.*')}}">
                    <a href="{{route('admin.whatsapp.contacts.index')}}" class="nav-link">
                        <i class="menu-icon fab fa-whatsapp"></i>
                        <span class="menu-title">@lang('WhatsApp Contacts')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.faq.*')}}">
                    <a href="{{route('admin.faq.index')}}" class="nav-link">
                        <i class="menu-icon las la-question-circle"></i>
                        <span class="menu-title">@lang('FAQs')</span>
                    </a>
                </li>


                <li class="sidebar-menu-item {{menuActive('admin.spotlight.*')}}">
                    <a href="{{route('admin.spotlight.index')}}" class="nav-link">
                        <i class="menu-icon las la-star"></i>
                        <span class="menu-title">@lang('Daily Spotlights')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.frontend.sections', null, ['key','banner'])}}">
                    <a href="{{route('admin.frontend.sections','banner')}}" class="nav-link">
                        <i class="menu-icon las la-images"></i>
                        <span class="menu-title">@lang('Header Banner')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.audio.*')}}">
                    <a href="{{route('admin.audio.index')}}" class="nav-link">
                        <i class="menu-icon las la-music"></i>
                        <span class="menu-title">@lang('Audio Player')</span>
                    </a>
                </li>

                <li class="sidebar-menu-item {{menuActive('admin.red-bag.*')}}">
                    <a href="{{route('admin.red-bag.index')}}" class="nav-link">
                        <i class="menu-icon las la-gift"></i>
                        <span class="menu-title">@lang('Red Bag')</span>
                    </a>
                ...
                <li class="sidebar-menu-item {{menuActive('admin.app.download.*')}}">
                    <a href="{{route('admin.app.download.index')}}" class="nav-link">
                        <i class="menu-icon las la-mobile"></i>
                        <span class="menu-title">@lang('App Download')</span>
                    </a>
                </li>
