    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <form action="" method="POST" id="deleteForm">
                @csrf
                <div class="modal-body">
                    <p>@lang('Are you sure you want to delete this FAQ?')</p>
                </div>
                <div class="modal-footer">
...
(function($){
    ...
    $('.editBtn').on('click', function(){
        ...
        modal.find('[name=answer]').val(data.answer);
        ...
        $('#editForm').attr('action', '{{ route("admin.faq.update", "") }}/' + data.id);
        modal.modal('show');
    });

    $('.deleteBtn').on('click', function(){
        var id = $(this).data('id');
        $('#deleteForm').attr('action', '{{ route("admin.faq.delete", "") }}/' + id);
        $('#deleteModal').modal('show');
    });

    $('.statusBtn').on('click', function(){
        var id = $(this).data('id');
        $.post('{{ route("admin.faq.status", "") }}/' + id, {_token: '{{ csrf_token() }}'}, function(){
            location.reload();
        });
    });
