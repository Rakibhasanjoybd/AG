...
Route::middleware('admin')->group(function () {
    ...
    Route::controller('ManageUsersController')->name('users.')->prefix('users')->group(function () {
        ...
        Route::post('reset-wallet-pin/{id}', 'resetWalletPin')->name('reset.wallet.pin');
    ...
    // Free User System
    Route::controller('FreeUserController')->name('free-user.')->prefix('free-user-system')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('update', 'update')->name('update');
        Route::get('free-users', 'freeUsers')->name('free-users');
        Route::get('premium-users', 'premiumUsers')->name('premium-users');
    });

    // Premium Referral Commissions
    Route::controller('PremiumCommissionController')->name('premium.commission.')->prefix('premium-commissions')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::get('pending', 'pending')->name('pending');
        Route::get('approved', 'approved')->name('approved');
        Route::get('locked', 'locked')->name('locked');
    ...
    // Announcements
    Route::controller('ManageAnnouncementController')->name('announcement.')->prefix('announcements')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('/store', 'store')->name('store');
        Route::post('/update/{id}', 'update')->name('update');
    ...
    // Popup Announcements
    Route::controller('ManagePopupController')->name('popup.')->prefix('popup-announcements')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::get('/create', 'create')->name('create');
        Route::post('/store', 'store')->name('store');
        Route::get('/edit/{id}', 'edit')->name('edit');
        ...
        Route::post('/reset-views/{id}', 'resetViews')->name('resetViews');
        Route::get('/statistics/{id}', 'statistics')->name('statistics');
    });

    // Video Tutorials
    Route::controller('ManageVideoTutorialController')->name('tutorial.')->prefix('video-tutorials')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('/store', 'store')->name('store');
        Route::post('/update/{id}', 'update')->name('update');
        Route::post('/delete/{id}', 'delete')->name('delete');
    ...
    // AGCO Family Brands
    Route::controller('ManageAgcoBrandController')->name('agco.brand.')->prefix('agco-brands')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('/store', 'store')->name('store');
        Route::post('/update/{id}', 'update')->name('update');
        Route::post('/delete/{id}', 'delete')->name('delete');
    ...
    // WhatsApp Customer Care Contacts
    Route::controller('WhatsappContactController')->name('whatsapp.contacts.')->prefix('whatsapp-contacts')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::get('/create', 'create')->name('create');
        Route::post('/store', 'store')->name('store');
        Route::get('/edit/{id}', 'edit')->name('edit');
    ...
    // FAQs
    Route::controller('ManageFaqController')->name('faq.')->prefix('faqs')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('/store', 'store')->name('store');
        Route::post('/update/{id}', 'update')->name('update');
        Route::post('/delete/{id}', 'delete')->name('delete');
    ...
    // Daily Spotlights
    Route::controller('ManageDailySpotlightController')->name('spotlight.')->prefix('daily-spotlights')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('/store', 'store')->name('store');
        Route::post('/update/{id}', 'update')->name('update');
        Route::post('/delete/{id}', 'delete')->name('delete');
    ...
    // Audio Player
    Route::controller('ManageAudioPlayerController')->name('audio.')->prefix('audio-player')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('/store', 'store')->name('store');
        Route::post('/update/{id}', 'update')->name('update');
        Route::post('/delete/{id}', 'delete')->name('delete');
    ...
    Route::controller('AppDownloadController')->name('app.download.')->prefix('app-download')->group(function () {
        Route::get('/', 'index')->name('index');
        Route::post('/update/{platform}', 'update')->name('update');
        Route::post('/status/{platform}', 'status')->name('status');
        Route::post('/delete/{platform}', 'delete')->name('delete');
    });
    ...
    Route::controller('RedBagController')->name('red-bag.')->prefix('red-bag')->group(function () {
        ...
        Route::post('/mark-fraud/{id}', 'markFraud')->name('mark-fraud');
        Route::get('/devices', 'devices')->name('devices');
        Route::post('/block-device/{id}', 'blockDevice')->name('block-device');
